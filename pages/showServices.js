    ...
    <>
      ...
      <div className="text-gray-600  body-font min-h-screen">
        <div className="container sm:px-1 px-5 py-16 mx-auto">
          {/* <div className="flex  py-2 items-center  lg:w-auto mx-2 mb-2 ">
            <div className="relative  mx-2  flex justify-center    lg:enabled: lg:w-80 xl:w-96">
              ...
              <input
                ...
                name="email"
                id="topbar-search"
                className="bg-white border-2 border-slate-800 text-gray-900 sm:text-sm rounded-md focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Search"
              />
            </div>
          </div> */}
